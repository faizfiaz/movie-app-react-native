...
export default class Home extends Component {
    ...
    loadJSONData() {
        fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=43954c2d8a99381ff77508aeaa6d3a1a', { method: "GET" })
            ...
            .then((data) => {
               ...
               // console.log(array)
                var ds = new ListView.DataSource({ rowHasChanged: (r1, r2) => r1 !== r2 });
                this.setState({ dataSource: ds.cloneWithRows(array[0]) });
            })
            .done(() => {
